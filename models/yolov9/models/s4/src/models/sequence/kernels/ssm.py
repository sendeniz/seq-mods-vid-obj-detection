...
import models.s4.src.models.hippo.hippo as hippo
import models.s4.src.models.sequence.kernels.dplr as dplr
from models.s4.src.models.functional.krylov import krylov, power
...
from models.s4.src.models.functional.cauchy import cauchy_naive
from models.s4.src.models.functional.vandermonde import log_vandermonde_naive
from models.s4.src.models.functional.vandermonde import log_vandermonde_transpose_naive

# Base Kernel class
from models.s4.src.models.sequence.kernels.kernel import Kernel
...
class SSMKernelDPLR(SSMKernelDiag):
    ...
    def forward(self, state=None, rate=1.0, L=None):
        ...
        #k_f = k_f * 2 / (1 + omega)
        k_f = k_f * 2 / (1 + omega.to(k_f.device))
