...
from models.s4.src.models.nn import Normalization, StochasticDepth, DropoutNd
from models.s4.src.models.sequence import SequenceModule
from models.s4.src.models.sequence.modules.pool import registry as pool_registry
from models.s4.src.models.nn.residual import registry as residual_registry
import models.s4.src.utils as utils
import models.s4.src.utils.registry as registry
...
class SequenceResidualBlock(SequenceModule):
    ...
    def forward(self, x, state=None, **kwargs):
        #print('SSM layer input shape:', x.shape)
        y = x
        ...
        if self.bidirectional:
            ...
            #print('Not using Bidrectional')
            y = y_for

        # Residual
        #print('Residual type:', self.residual)
        ...
        #print('Pool type:', self.pool)
        #print('shape before pool:', y.shape)
        # Pool
        if self.pool is not None: y, _ = self.pool(y)
        #print('shape after pool:', y.shape)
