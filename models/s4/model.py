...
from models.s4.aux.encoders import StandardEncoder
from models.s4.block import S4Block
from models.s4.dsp.utils import next_pow2
...
class S4Model(nn.Module):
    ...
    def __init__(
        ...
        *self.seq_len_schedule, (self.seq_len_out, _) = _seq_length_schedule(
        ...
        if wavelet_tform:
            from models.s4.dsp.cwt import Cwt, CwtWithAdapter
