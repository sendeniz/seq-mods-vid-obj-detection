...
from holov4_enas_vid_train_fn import trainholov4_enas_vid_bptt, testholov4_enas_vid
...
def main(rank, world_size, args):
    ...
    writer = SummaryWriter(log_dir="logs/results_yolov4enas_vid")
    ...
    for run in range(1,2):
        ...
        for epoch in range(args.nepochs):
            ...
            print("Train function reduce all completed.")
            ...
            print("Test function reduce all completed.")
            ...
            if (
                ...
                #dist.all_reduce(train_map)
                #dist.all_reduce(train_recall)
                #dist.all_reduce(train_precision)

                #train_map /= world_size
                #train_recall /= world_size
                #train_precision /= world_size
            ...
            if args.save_model and (
                ...
                if dist.get_rank() == 0:
                    torch.save(
                        ...
                        path_cpt_file + f"Yolov4Enas_608_vid_run_{run}.cpt",
                    )
